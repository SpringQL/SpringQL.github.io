...
You can configure SpringQL in TOML format.

Default values are used if you don't set the key-value in TOML.

Here shows the default values and what they mean.

```toml title="Default configuration values"
[worker]
