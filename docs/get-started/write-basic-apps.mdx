...
We recommend you to learn fundamental concepts of stream processing in [Learn SpringQL](../learn-springql/index)
...
Also, you may find other meaningful examples in [Real-World Examples](../real-world-example/index).
